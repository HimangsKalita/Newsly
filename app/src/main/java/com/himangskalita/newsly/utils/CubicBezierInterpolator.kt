...
class CubicBezierInterpolator(start: PointF, end: PointF) : Interpolator {
    ...
    companion object {
        val DEFAULT: CubicBezierInterpolator = CubicBezierInterpolator(0.25, 0.1, 0.25, 1.0)
        val EASE_OUT: CubicBezierInterpolator = CubicBezierInterpolator(0.0, 0.0, .58, 1.0)
        val EASE_OUT_QUINT: CubicBezierInterpolator = CubicBezierInterpolator(.23, 1.0, .32, 1.0)
        val EASE_IN: CubicBezierInterpolator = CubicBezierInterpolator(.42, 0.0, 1.0, 1.0)
        val EASE_BOTH: CubicBezierInterpolator = CubicBezierInterpolator(.42, 0.0, .58, 1.0)
        val EASE_IN_OUT_QUAD: CubicBezierInterpolator =
            CubicBezierInterpolator(0.455, 0.03, 0.515, 0.955)
    }
}
